...
assert(app.includes('const VERSION = 38'), 'La versión de la aplicación no está actualizada');
assert(sw.includes("const CACHE = 'nucleo-v15'"), 'La caché offline no se ha renovado');
